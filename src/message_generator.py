...
class MessageGenerator:
    ...
    def getMessages(self):
        generators = {
            "Lenkhilfe_1": self.generate_Lenkhilfe1,
            #"BSGKombi": self.generate_BSGKombi,
            "Motor_5": self.generate_Motor5,
            "Motor_1": self.generate_Motor1,
            "Bremse_2": self.generate_Bremse2,
            "Bremse_1": self.generate_Bremse1,
            "Airbag_1": self.generate_Airbag1,
            "Getriebe_2": self.generate_Getriebe2,
            "Motor_2": self.generate_Motor2,
        }
